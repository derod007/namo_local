...
<table class="table table-bordered bs-xs-table jsb-info">
	...
	<tr>
		...
		<br class="clear"/>
		<div class="row">
			<div class="col-sm-6"><button class="btn btn-default btn-block col-sm-4" type="button" onclick="document.location.href='./loan-write.php?w=u&wr_id=<?php echo $wr_id;?>';">신청정보</button></div>
			<div class="col-sm-6"><button class="btn btn-default btn-block col-sm-4" type="button" onclick="document.location.href='./loan-list.php';">목록으로</button></div>
		</div>

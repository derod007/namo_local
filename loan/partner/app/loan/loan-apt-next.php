...
if(!$row['wr_deposit']) $row['wr_deposit'] = 0;
if(!$row['wr_agree']) $row['wr_agree'] = 'Y';
?>
<style>
</style>
...
<div style="padding:15px;margin:auto;">
	<form id="flogin" name="flogin" action="./loan-apt-calc-loading.php" method="post" class="jsb-form" onSubmit="aptCalcSubmit();">
					...
					<div id="tabs_table">
						<table class="table table-striped table-bordered nowrap" style="width:100%; max-width:600px;margin-bottom: 5px;">
							...
							<tr>
								...
								<td><input type="checkbox" name="mor_same[]" value="1" style="display:inline-block; width:30px;"> 동일</td>
...
function morAddRow(one='',two='') {
	...
	str += "  <td><input type=\"checkbox\" name=\"mor_same[]\" value=\"1\" style=\"display:inline-block; width:30px;\"> 동일</td>";

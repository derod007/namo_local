...
<div style="padding:15px;margin:auto;">
	<form id="flogin" name="flogin" action="/app/loaninfo-act.php" method="post" class="jsb-form">
...
?>
			<div class="row"><label class="col-sm-2 control-label">첨부파일 <?php echo "(".$filecnt .")";?><br/><a href="./loaninfo-file.php?wr_id=<?php echo $wr_id;?>">관리 &gt;&gt;</a></label>
				<div class="col-sm-10">
		<?php
			$cnt = $pjfile['count'];
			if ($cnt) {
		...
		?>
			...
			<div class="row">
				...
				<div class="col-sm-4"><button class="btn btn-default btn-block col-sm-4" type="button" onclick="document.location.href='./loaninfo-list.php';">목록으로</button></div>
			</div>
		</form>
	   ...
	   <div class="form-group col-sm-4" >
			<form id="fjudge" name="fjudge" action="/app/loaninfo-act.php" method="post" class="jsb-form">

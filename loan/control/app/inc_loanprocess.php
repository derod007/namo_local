...
$sql = " select *, (select reg_date from log_action where wr_id = write_loaninfo.wr_id and next_status='30' limit 1 ) as procdate from write_loaninfo where wr_status = '30' order by procdate desc limit 5 ";

...
<php
	...
	<div class="manager_wrap">
		...
		<div style="margin:auto; display:flex; justify-content: space-between;">
			<form id="flogin" name="flogin" action="/app/new/loan-act.php" method="post" class="jsb-form" style="width: 605px;">
				<input type="hidden" name="w" value="<?php echo $w; ?>">
				<input type="hidden" name="wr_id" value="<?php echo $wr_id; ?>">
				<input type="hidden" name="prev_status" value="<?php echo $row['wr_status']; ?>">

				<!-- 접수내용(왼쪽) 화면 시작 -->
				<div class="form-group" style="background-color: #eeeeee; padding:20px;">
					...
					<div class="">
						...
						<div class="section collateral-info">
							<div class="form-content">
								...
								<div class="form_field"><label class="w_20 field_title">담보주소<span class="p_l_2" style="color: #BF1212;">*</span> <?php echo $duppop; ?></label>
									<div class="w_80">
								...
								<div class="form_field bg_gr"><label class="w_20 field_title">전용면적<span class="p_l_2" style="color: #BF1212;">*</span> &nbsp; <span id="win_real" class="winreal"><i class="fas fa-chart-bar"></i></span></label>
									<div class="w_80"><input type="text" name="wr_m2" id="wr_m2" value="<?php echo $row["wr_m2"]; ?>" class="form-control" style="display:inline-block; width:100px;" placeholder="000.00"> ㎡ (제곱미터)</div>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-content">
								<div class="form_field"><label class="w_20 field_title">희망금액</label>
									<div class="field_area">
										<input type="text" id="wr_amount" name="wr_amount" style="display:inline-block; width:334px;" value="<?php echo $row["wr_amount"]; ?>" class="form-control">
								...
								<div class="form_field"><label class="w_20 field_title">임대차보증금</label>
									<div class=""><input type="text" id="wr_rental_deposit" name="wr_rental_deposit" style="display:inline-block; width:200px;" placeholder="있을경우 작성 / 단위 만원" value="<?php echo $row["wr_rental_deposit"]; ?>" class="form-control"> 원</div>
								</div>
								<!-- park 임시 담보정보 (추후 삭제 예정) -->
								<div class="form_field"><label class="w_20 field_title">기타 정보</label>
									<div class="w_80"><textarea id="wr_cont2" name="wr_cont2" class="form-control" style="height:80px;" placeholder="자유양식 작성"><?php echo $row["wr_cont2"]; ?></textarea></div>
								</div>
					...
					?>
					<div class="row"><label class="col-sm-2 control-label">첨부파일 <?php echo "(" . $filecnt . ")"; ?><br /></label>
						<div class="col-sm-10">
							<?php
							$cnt = $pjfile['count'];
							if ($cnt) {
			...
			<form id="fjudge" name="fjudge" action="/app/new/loan-act.php" method="post" class="jsb-form">
				...
				<div class="calculation-section" id="calculation-section">
					...
					<div class="limit_calc_zone">
						...
						<button type="button" id="calculateBtn" class="w_100">계산하기</button>
					</div>
				</div>

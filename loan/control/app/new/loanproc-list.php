...
$sql = " select *, (select reg_date from log_action where wr_id = loan_write.wr_id and next_status='30' limit 1 ) as procdate from loan_write where wr_status = '30' order by procdate desc";
...
?>  
    <tr role="row">
      ...
      <td class="align-center"><?php echo (!$v['pt_name'])? $partners[$v['pt_idx']]['mb_bizname'] : $partners[$v['pt_idx']]['mb_bizname']."(".$v['pt_name'].")";?></td>
...
<script>
$(function () {
	commonjs.selectNav("navbar", "newloanproc");
});
</script>

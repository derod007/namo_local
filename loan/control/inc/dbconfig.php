...
define('MYSQL_USER', 'loanpartner');
define('MYSQL_PASSWORD', 'namo12#$');
define('MYSQL_DB', 'loanpartner');
...
define('JSB_EDITOR_URL',      JSB_URL.'/vendor/smarteditor2');
...
define('JSB_EDITOR_PATH',      JSB_PATH.'/vendor/smarteditor2');
...
$allow_ips[] = "58.123.54.42"; 	// guest1 240724
$allow_ips[] = "61.101.123.162"; 	// 히어로
$allow_ips[] = "127.0.0.1"; 	// 로컬 개발용

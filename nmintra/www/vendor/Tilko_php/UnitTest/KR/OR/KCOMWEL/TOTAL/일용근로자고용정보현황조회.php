...
try {
    ...
    $Rest->SetEndPointUrl($Constant::ApiHost . "api/v1.0/kcomwel/selectilyonggeunrojainfojohoe");
    ...
    $Rest->AddBody("DaesangYYFrom", "", false);                         // 대상연도_시작(YYYY)
    $Rest->AddBody("DaesangYYTo", "", false);                           // 대상연도_종료(YYYY)
